...
/**
 * ppPlugin Name: Font Awesome Kit for Wordpress
 * ppPlugin URI: https://www.divi-magazine.com
 * ppDescription: Add Font Awesome Kit code to WordPress easily. Nothing more, nothing less.
 * ppVersion: 1.0
 * ppAuthor: Andras Guseo | The Divi Magazine
 * ppAuthor URI: https://www.divi-magazine.com
 * ppLicense: GPLv2 or later
 * ppLicense URI: http://www.gnu.org/licenses/gpl-2.0.html
 */
...
function tdm_fakitforwp_initialize_plugin_options() {
	...
	*/
	...
	register_setting(
		'tdm_fakitforwp_display_options',   // Settings group name
		'tdm_fakitforwp_display_options',   // Name of the option
		$args     // Arguments
	);
